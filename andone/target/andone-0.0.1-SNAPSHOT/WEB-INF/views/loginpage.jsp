...
<html>
  ...
  <p>&nbsp; </p>
  <p class="aa"><strong>登录界面</strong></p>
  <form name="frmLogin" action="${pageContext.request.contextPath }/login" method="post">
  	<table width="30%" height="160" border="1" align="center" background="#FFFF00">
  		<tr bgcolor="#FFFF00">
  			<td class="bb">用户名</td>
  			<td class="zxc">
  				<input name="username" type="text" class="bb" >
  			</td>
  		</tr>
  		<tr bgcolor="#FFFF00">
		  <td class="bb">密码</td>
  			<td class="zxc">
  				<input name="password" type="password" class="bb" >
  			</td>
  		</tr>
  		<tr bgcolor="#FFFF00">
  			<td colspan="2" class="qwe">
  ...
  <tr>
    <td class="qwe"><span class="sdasd">欢迎进入门禁监控系统</span></td>
  </tr>
